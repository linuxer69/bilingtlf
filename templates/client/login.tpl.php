<!-- templates/client/login.tpl.php -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Inter', sans-serif; }
        ...
        .card { background: #ffffff; padding: 40px; border-radius: 16px; box-shadow: 0 10px 25px -5px rgba(0, 0, 0, 0.05); border: 1px solid #e2e8f0; }
        ...
        .control { width: 100%; padding: 12px 16px; font-size: 15px; border: 1px solid #cbd5e1; border-radius: 8px; background-color: #f8fafc; }
...
<div class="wrapper">
    <div class="card">
        <div class="header">
            <h1>Sign In</h1>
            <p>Access your billing and client portal</p>
        </div>
        ...
        <form action="index.php" method="POST" autocomplete="off">
            ...
            <div class="form-group">
                ...
                <input type="email" id="email" name="email" class="control" placeholder="name@example.com" required autofocus>
            </div>

            <div class="form-group">
                <label class="label" for="password">Password</label>
                <input type="password" id="password" name="password" class="control" placeholder="Enter your password" required>
            </div>
